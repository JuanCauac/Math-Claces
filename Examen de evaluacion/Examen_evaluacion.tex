% Examen de evaluacion de nivel de matematica. Desde primaria hasta preparatoria. 
...
\usepackage[pdftex,
            ...
            pdftitle={Examen de Evaluacion},
            pdfsubject={matematicas},
            pdfkeywords={examen, evaluacion, matematicas}]{hyperref}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
